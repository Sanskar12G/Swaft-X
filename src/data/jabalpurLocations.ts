...
export const jabalpurLocations: JabalpurLocation[] = [
  ...
  { name: "Gwarighat", area: "South", lat: 23.1280, lng: 79.8640, fullAddress: "Gwarighat, Jabalpur, MP" },

  // Railway Stations
  { name: "Jabalpur Junction", area: "Railway", lat: 23.1700, lng: 79.9505, fullAddress: "Jabalpur Junction Railway Station, MP" },
  ...
  { name: "Samdariya Mall", area: "Mall", lat: 23.1745, lng: 79.9540, fullAddress: "Samdariya Mall, Wright Town, Jabalpur, MP" },
  { name: "South Avenue Mall", area: "Mall", lat: 23.1560, lng: 79.9210, fullAddress: "South Avenue Mall, Jabalpur, MP" },

  // Hospitals
  { name: "Medical College Hospital", area: "Healthcare", lat: 23.1810, lng: 79.9570, fullAddress: "NSCB Medical College, Jabalpur, MP" },
  ...
  { name: "Rani Durgavati University", area: "Education", lat: 23.1830, lng: 79.9780, fullAddress: "Rani Durgavati University, Jabalpur, MP" },
  { name: "IIITDM Jabalpur", area: "Education", lat: 23.1765, lng: 80.0260, fullAddress: "IIITDM, Dumna Airport Road, Jabalpur, MP" },
  { name: "Engineering College", area: "Education", lat: 23.1810, lng: 79.9650, fullAddress: "Jabalpur Engineering College, Jabalpur, MP" },
  ...
  { name: "Marble Rocks", area: "Tourist", lat: 23.1120, lng: 79.7990, fullAddress: "Marble Rocks, Bhedaghat, Jabalpur, MP" },
  { name: "Dhuandhar Falls", area: "Tourist", lat: 23.1150, lng: 79.7940, fullAddress: "Dhuandhar Falls, Bhedaghat, Jabalpur, MP" },
  ...
  { name: "Tilwara Ghat", area: "Tourist", lat: 23.1430, lng: 79.9210, fullAddress: "Tilwara Ghat, Jabalpur, MP" },
  { name: "Rani Durgavati Museum", area: "Tourist", lat: 23.1645, lng: 79.9360, fullAddress: "Rani Durgavati Museum, Jabalpur, MP" },

  // Temples
  { name: "Pisanhari Ki Madhiya", area: "Temple", lat: 23.1300, lng: 79.9550, fullAddress: "Pisanhari Ki Madhiya, Jabalpur, MP" },
  { name: "Chausath Yogini Temple", area: "Temple", lat: 23.1095, lng: 79.8030, fullAddress: "Chausath Yogini Temple, Bhedaghat, Jabalpur, MP" },
  ...
  { name: "Bargi", area: "Residential", lat: 23.0790, lng: 79.9450, fullAddress: "Bargi, Jabalpur, MP" },
  ...
  { name: "Dumna Nature Reserve", area: "Park", lat: 23.1920, lng: 80.0350, fullAddress: "Dumna Nature Reserve, Jabalpur, MP" },
  { name: "Science Park", area: "Park", lat: 23.1755, lng: 79.9480, fullAddress: "Science Park, Jabalpur, MP" },

  // Airport
  { name: "Dumna Airport", area: "Airport", lat: 23.1778, lng: 80.0520, fullAddress: "Dumna Airport, Jabalpur, MP" },
  ...
  { name: "High Court", area: "Government", lat: 23.1630, lng: 79.9380, fullAddress: "Madhya Pradesh High Court, Jabalpur, MP" },
  ...
  { name: "Barela", area: "Outskirts", lat: 23.1015, lng: 79.8394, fullAddress: "Barela, Jabalpur, MP" },
  ...
  { name: "Damoh Road", area: "Road", lat: 23.1848, lng: 79.9645, fullAddress: "Damoh Road, Jabalpur, MP" },
  { name: "Katangi Road", area: "Road", lat: 23.1816, lng: 79.9708, fullAddress: "Katangi Road, Jabalpur, MP" },
  ...
  { name: "Small Gwarighat", area: "Residential", lat: 23.1327, lng: 79.8719, fullAddress: "Gwarighat Area, Jabalpur, MP" },
  ...
  { name: "Sihora Road", area: "Road", lat: 23.2148, lng: 79.9404, fullAddress: "Sihora Road Side, Jabalpur, MP" },
